...
const SEED_CHAT = `Human: Hi Elon, how is your day been?
...
Human: Just a regular day for me. How iss the progress with Mars colonization?
...
Elon: Always! But right now, I am particularly excited about Neuralink. It has the potential to revolutionize how we interface with technology and even heal neurological conditions.
`;
const formSchema = z.object({
  ...
  instructions: z
    .string()
    .min(200, { message: 'Instructions required at least 200 characters.' }),
  seed: z
    .string()
    .min(200, { message: 'Seed required at least 200 characters.' }),
  src: z.string().min(1, { message: 'Image is required.' }),
  categoryId: z.string().min(1, { message: 'Category is required.' }),
});

const CompanionForm = ({ initialData, categories }) => {
        ...
        >
            ...
            render={({ field }) => {
              return (
                <FormItem className='col-span-2 md:col-span-1'>
                  ...
                  <FormDescription>
                    Describe in detail your companion&apos;s back story and
                    relevant details.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
            ...
            render={({ field }) => {
              return (
                <FormItem className='col-span-2 md:col-span-1'>
                  ...
                  <FormDescription>
                    Describe in detail your companion's back story and relevant
                    details.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
          ...
          <div className='w-full flex justify-center '>
            <Button size='lg' disabled={isLoading}>
              {initialData ? 'Edit your companion' : 'Create Companion'}
